...
const baseBusinesses = [
  {id: 1, name: "Grass Grower", unlocked: true, mps: 1, price: 0, icon: "/grass.png", caption: "You try your hand at selling on silk way. Returns are negligible at best ", isFunctioning: true, competition: "", tax: 0, level: 1, mpc: 1, upgradeCost: 10}, 
  {id: 2, name: "Big time dealer", unlocked: false, mps: 10, price: 100, icon: "/drug.png", caption: "You tried your hand at writing your own self insert harem isekai trash", isFunctioning: true, competition: "", tax: 0, level: 1, mpc: 10, upgradeCost: 100},
  {id: 3, name: "Arms dealer", unlocked: false, mps: 100, price: 1000, icon: "/gun.png", caption: "The only people making you any amount of profit are scalpers", isFunctioning: true, competition: "", tax: 0, level: 1, mpc: 20, upgradeCost: 500}, 
  {id: 4, name: "Bioweapon testing", unlocked: false, mps: 500, price: 10000, icon: "/test.png", caption: "Maybe this means you get the food for free?", isFunctioning: true, competition: "", tax: 0, level: 1, mpc: 30, upgradeCost: 1000},
  {id: 5, name: "Organ dealer", unlocked: false, mps: 1000, price: 10000000, icon: "/brain.png", caption: "If you can't win at a casino, just buy the place.", isFunctioning: true, competition: "", tax: 0, level: 1, mpc: 100, upgradeCost: 10000},
  {id: 6, name: "Poison manufacturing", unlocked: false, mps: 5000, price: 10000000, icon: "/poison.png", caption: "Your customers say onii-chan unironically", isFunctioning: true, competition: "", tax: 0, level: 1, mpc: 1000, upgradeCost: 50000}, 
  {id: 7, name: "Assasination service", unlocked: false, mps: 10000, price: 100000000, icon: "/skull.png", caption: "The only thing good about these is the graphics card", isFunctioning: true, competition: "", tax: 0, level: 1, mpc: 5000, upgradeCost: 100000},
  {id: 8, name: "Illegal nuclear power", unlocked: false, mps: 20000, price: 1000000000, icon: "/nuclear.png", caption: "Silk road reupload", isFunctioning: true, competition: "", tax: 0, level: 1, mpc: 10000, upgradeCost: 500000},
  {id: 9, name: "Illegal oil rig", unlocked: false, mps: 50000, price: 10000000000, icon: "/oil.png", caption: "Your position has earned you many enemies", isFunctioning: true, competition: "", tax: 0, level: 1, mpc: 10000, upgradeCost: 1000000},
  {id: 10, name: "Nuclear weapons dealer", unlocked: false, mps: 100000, price: 100000000000, icon: "/nuclear.png", caption: "You learn advanced alchemy to turn printer paper into banknotes", isFunctioning: true, competition: "", tax: 0, level: 1, mpc: 100000, upgradeCost: 10000000},
];
